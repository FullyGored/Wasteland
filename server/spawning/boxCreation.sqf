...
switch(_selectedBox) do {
	...
	clearWeaponCargoGlobal _currBox;
        ...
        _currBox addWeaponCargoGlobal ["M16A4",30];
	_currBox addWeaponCargoGlobal ["M16A4_GL",10];
	...
	_currBox addWeaponCargoGlobal ["M4A1_Aim",30];
	_currBox addWeaponCargoGlobal ["M9",8];
	...
	clearWeaponCargoGlobal _currBox;
        ...
        // Add new weapons before ammunition
        _currBox addWeaponCargoGlobal ["AK_107_kobra",20];
	_currBox addWeaponCargoGlobal ["AK_107_GL_kobra",20];
	_currBox addWeaponCargoGlobal ["MakarovSD",8];

        // Add ammunition
        _currBox addMagazineCargoGlobal ["30Rnd_545x39_AK",95];
        _currBox addMagazineCargoGlobal ["8Rnd_9x18_MakarovSD",24];
        _currBox addMagazineCargoGlobal ["HandGrenade",10];
        _currBox addMagazineCargoGlobal ["1Rnd_HE_GP25",25];
        _currBox addMagazineCargoGlobal ["1Rnd_SMOKE_GP25",45];
    };
	...
	clearWeaponCargoGlobal _currBox;
        ...
        // Add new weapons before ammunition
        _currBox addWeaponCargoGlobal ["AKS_74_kobra",40];
	_currBox addWeaponCargoGlobal ["AK_74",2];
	_currBox addWeaponCargoGlobal ["Saiga12K",15];
	_currBox addWeaponCargoGlobal ["Makarov",8];
        ...
        _currBox addMagazineCargoGlobal ["HandGrenade",5];
        _currBox addMagazineCargoGlobal ["8Rnd_B_Saiga12_74Slug",45];
        _currBox addMagazineCargoGlobal ["8Rnd_B_Saiga12_Pellets",45];
    };
	...
	clearWeaponCargoGlobal _currBox;
        ...
        // Add new weapons before ammunition
        _currBox addWeaponCargoGlobal ["G36C",30];
	_currBox addWeaponCargoGlobal ["G36_C_SD_eotech",2];
	_currBox addWeaponCargoGlobal ["G36a",2];
	_currBox addWeaponCargoGlobal ["M9",8];

        // Add ammunition
        _currBox addMagazineCargoGlobal ["30Rnd_556x45_G36",95];
	...
	_currBox addWeaponCargoGlobal ["AA12_PMC",15];
	_currBox addWeaponCargoGlobal ["M9",8];

        // Add ammunition
        _currBox addMagazineCargoGlobal ["30Rnd_556x45_Stanag",95];
        _currBox addMagazineCargoGlobal ["20Rnd_B_AA12_Pellets",45];
        _currBox addMagazineCargoGlobal ["20Rnd_B_AA12_74Slug",45];
	...
	clearWeaponCargoGlobal _currBox;
        ...
        // Add new weapons before ammunition
        _currBox addWeaponCargoGlobal ["m8_compact_pmc",30];
	...
	_currBox addWeaponCargoGlobal ["M9SD",4];
        ...
        // Add ammunition
        _currBox addMagazineCargoGlobal ["30Rnd_556x45_Stanag",95];
        _currBox addMagazineCargoGlobal ["30Rnd_556x45_StanagSD",95];
	...
	clearWeaponCargoGlobal _currBox;
        ...
        _currBox addWeaponCargoGlobal ["BAF_L85A2_UGL_Holo",40];
        ...
        _currBox addMagazineCargoGlobal ["30Rnd_556x45_Stanag",95];
        _currBox addMagazineCargoGlobal ["5x_22_LR_17_HMR",8];
        _currBox addMagazineCargoGlobal ["15Rnd_9x19_M9",24];
	...
	clearWeaponCargoGlobal _currBox;
        ...
        // Add new weapons before ammunition
        _currBox addWeaponCargoGlobal ["AKS_74_kobra",30];
	_currBox addWeaponCargoGlobal ["AKS_74_pso",3];
	_currBox addWeaponCargoGlobal ["FN_FAL",3];
        _currBox addWeaponCargoGlobal ["VSS_Vintorez",1];

        // Add ammunition
        _currBox addMagazineCargoGlobal ["30Rnd_762x39_AK47",95];
        _currBox addMagazineCargoGlobal ["HandGrenade",5];
