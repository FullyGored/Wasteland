//	@file Version: 1.0
//	@file Name: mission_CQCWepCache.sqf
...
_result = 0;
_missionMarkerName = "CQC_WeaponCache_Marker";
_missionType = "CQC Weapons Stash";
#ifdef __A2NET__
...
if(_result == 1) then
{
	...
	//Mission Complete.
    deleteGroup CivGrpC;
    _hint = parseText format ["<t align='center' color='%2' shadow='2' size='1.75'>Objective Complete</t><br/><t align='center' color='%2'>------------------------------</t><br/><t align='center' color='%3' size='1.25'>%1</t><br/><t align='center' color='%3'>The CQC weapons have been secured</t>", _missionType, successMissionColor, subTextColor];
	[nil,nil,rHINT,_hint] call RE;
