//	@file Version: 1.0
//	@file Name: mission_SniperWepCache.sqf
...
_result = 0;
_missionMarkerName = "Sniper_WeaponCache_Marker";
_missionType = "Sniper Weapons Stash";
#ifdef __A2NET__
...
[_box,"mission_Sniper_Weapons"] call fn_refillbox;

_hint = parseText format ["<t align='center' color='%2' shadow='2' size='1.75'>Close Quarters Objective</t><br/><t align='center' color='%2'>------------------------------</t><br/><t align='center' color='%3' size='1.25'>%1</t><br/><t align='center' color='%3'>A Sniper weapons stash has been reported near the marker</t>", _missionType,  cqMissionColor, subTextColor];
...
if(_result == 1) then
{
	...
	//Mission Complete.
    deleteGroup CivGrpC;
    _hint = parseText format ["<t align='center' color='%2' shadow='2' size='1.75'>Objective Complete</t><br/><t align='center' color='%2'>------------------------------</t><br/><t align='center' color='%3' size='1.25'>%1</t><br/><t align='center' color='%3'>The Sniper weapons have been secured</t>", _missionType, successMissionColor, subTextColor];
	[nil,nil,rHINT,_hint] call RE;
