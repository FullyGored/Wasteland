//	@file Version: 1.0
//	@file Name: mission_HeavyHeli.sqf
...
_result = 0;
_missionMarkerName = "HeavyHeli_Marker";
_missionType = "Heavy Lifter Helicopter";
#ifdef __A2NET__
...
_vehicleClass = ["CH_47F_BAF","CH_47F_BAF","MV22"] call BIS_fnc_selectRandom;
