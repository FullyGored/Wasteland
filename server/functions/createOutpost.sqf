...
Edited by armatec
Modified to support Biject HEalth system by TOG FF
...
for "_i" from 0 to ((count _objs) - 1) do
{
		...
		clearVehicleInit _newObj;  //Stop weapon boxes refilling themselves
                ...
                _newObj setVariable["health",30,true];
                _newObj setVariable["healthTotal",30,true];
                _newObj setVariable["isCritical",false,true];
                _newObj setVariable["isExplosiveImmune",false,true];
                _newObj setVariable["isBallisticImmune",false,true];
                _newObj setVariable["spawnpos",_newPos,true];
                _newObj setVariable["respawn",false,true];
                _newObj addEventHandler ["HandleDamage",{ [_this select 0,_this select 2,_this select 4] call onObjectHit }];
