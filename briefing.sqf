player createDiarySubject ["facefirst", "Face First Information"];
...
player createDiaryRecord["facefirst",
[
"Credits",
"
<br/>
	FF Developers:<br/><br/>
	Developer - Fully<br/>
	Developer - Redshirt_Ensign<br/>
        Developer - Bench<br/>
	Designer - Veilo<br/>
	Server Host - Fully<br/>
"
]
];
...
"
The Wasteland is a team versus team versus team sandbox survival experience. The objective of this mission is to rally your faction, scavenge supplies, weapons, and vehicles, and destroy the other factions. It is survival at its best! Keep in mind this is a work in progress, please direct your reports to Face First devs.
<br/><br/>
...
A. Simply go into global chat and get the attention of one of the admins and make a report if the offence is serious.
<br/>
"]
];
